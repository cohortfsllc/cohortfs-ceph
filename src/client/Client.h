...
private:
  ...
  int _mkdir(Inode *dir, const char *name, mode_t mode, int uid=-1, int gid=-1, inodeno_t si = 0);
  int _rmdir(Inode *dir, const char *name, int uid=-1, int gid=-1);
  int _symlink(Inode *dir, const char *name, const char *target, int uid=-1, int gid=-1, inodeno_t si = 0);
  ...
  int _open(Inode *in, int flags, mode_t mode, Fh **fhp, int uid=-1, int gid=-1, inodeno_t si = 0);
  int _create(Inode *in, const char *name, int flags, mode_t mode, Inode **inp, Fh **fhp, int uid=-1, int gid=-1, inodeno_t si = 0);
  int _release(Fh *fh);
...
public:
  ...
  int ll_mkdir(vinodeno_t vino, const char *name, mode_t mode, struct stat *attr, int uid = -1, int gid = -1, inodeno_t si = 0);
  int ll_mkdir_precise(vinodeno_t vino, const char *name, mode_t mode, struct stat_precise *attr, int uid = -1, int gid = -1, inodeno_t si = 0);
  int ll_symlink(vinodeno_t vino, const char *name, const char *value, struct stat *attr, int uid = -1, int gid = -1, inodeno_t si = 0);
  int ll_symlink_precise(vinodeno_t vino, const char *name, const char *value, struct stat_precise *attr, int uid = -1, int gid = -1, inodeno_t si = 0);
  ...
  int ll_open(vinodeno_t vino, int flags, Fh **fh, int uid = -1, int gid = -1, inodeno_t si = 0);
  int ll_create(vinodeno_t parent, const char *name, mode_t mode, int flags, struct stat *attr, Fh **fh, int uid = -1, int gid = -1, inodeno_t si = 0);
  int ll_create_precise(vinodeno_t parent, const char *name, mode_t mode, int flags, struct stat_precise *attr, Fh **fh, int uid = -1, int gid = -1, inodeno_t si = 0);
