...
struct erasure_params {
  ...
  uint32_t k; /* Count of data stripes in a block/object */
  uint32_t m; /* Count of coding stripes in a block/object */
  uint32_t w; /* Word size */
  uint32_t packetsize; /* Size of packets (subdivisions of a stripe) */
  uint32_t size; /* Size of each stripe, in bytes. */
