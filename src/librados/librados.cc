...
void librados::ObjectReadOperation::getxattrs(map<string, bufferlist> *pattrs,
					      int *prval)
{
  ::ObjectOperation *o = (::ObjectOperation *)impl;
			  ...
			  size_t len, uint64_t off)
{
  ...
  bufferlist bl;
  bufferptr bp = ceph::buffer::raw::create_static(len, buf);
  bl.push_back(bp);
				   ...
				   int *prval)
{
  ...
  ctx->out_bl.push_back(ceph::buffer::raw::create_static(len, buf));
