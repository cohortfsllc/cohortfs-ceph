...
/**
 * Genericobjectmap: Provide with key/value associated to oid_t APIs to caller
 * and avoid concerning too much. Wrap and combine KeyValueDB/ObjectMap APIs
 * with oid_t and adding clone capacity.
 *
 * Prefix space structure:
 *
 * - OIDO_SEQ: Contains leaf mapping from oid_t->Header(including
