                                        ...
                                        ThreadPool::TPHandle *handle)
{
  ...
  for (op_iterator i = transaction.begin(); i != transaction.end(); ++i) {
    ...
    case Transaction::OP_SPLIT_COLLECTION:
      r = _split_collection_create(i->cid, i->value1, i->value2, i->cid2, t);
      break;
    case Transaction::OP_SPLIT_COLLECTION2:
      r = _split_collection(i->cid, i->value1, i->value2, i->cid2, t);
      break;
...
int KeyValueStore::collection_list_range(const coll_t &c, ghobject_t start,
...
int KeyValueStore::collection_list_partial(const coll_t &c, ghobject_t start,
...
int KeyValueStore::collection_list(const coll_t &c, vector<ghobject_t>& ls)
{
...
int KeyValueStore::_split_collection(const coll_t &cid, uint32_t bits, uint32_t rem,
                                     const coll_t &dest, BufferTransaction &t)
{
  {
