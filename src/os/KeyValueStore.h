...
class KeyValueStore : public ObjectStore,
 ...
 public:
  ...
  int _collection_rmattr(const coll_t &c, const char *name, BufferTransaction &t);
  ...
  int collection_list(const coll_t &c, vector<ghobject_t>& oid);
  int collection_list_partial(const coll_t &c, ghobject_t start,
                              int min, int max, snapid_t snap,
                              vector<ghobject_t> *ls, ghobject_t *next);
  int collection_list_range(const coll_t &c, ghobject_t start, ghobject_t end,
