...
public:
  ...
  public:
    ...
    typedef cohort::lru::TreeX<
      Object, OidTree, OidLT, OidEQ, ObjKeyType, cohort::SpinLock,
...
#warning get_encoded_bytes() probably wrong // XXXX
 ...
 public:
  ObjectStore(const std::string& path_) :
    path(path_), logger(NULL), obj_lru(311 /* XXX move to conf */) {}
  virtual ~ObjectStore() {}
  ...
  {
  public:
    hobject_t next_oid; /* replace w/OID */
    uint32_t partition;
    uint32_t gen;
  };
