...
public:
  ...
  bool currently_queued_for_vol() { return latest_flag_point & flag_queued_for_vol; }
  ...
  const char *state_string() const {
    ...
    case flag_queued_for_vol: return "queued for vol";
    case flag_reached_vol: return "reached vol";
